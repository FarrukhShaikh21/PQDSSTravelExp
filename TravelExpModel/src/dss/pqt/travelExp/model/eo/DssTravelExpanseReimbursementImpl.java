...
// ---    Thu Sep 22 17:18:31 PKT 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class DssTravelExpanseReimbursementImpl extends EntityImpl {
    /**
    ...
    public enum AttributesEnum {
        ...
        WorkflowStatus,
        GisLocationIdFk,
        DssTravelexpanseAmountDtl,
        DssTravelexpanseDetail,
        DssTravelExpansePurposeDtl;
    ...
    public static final int VOUCHERIDPK = AttributesEnum.VoucherIdPk.index();
    public static final int EMPIDFK = AttributesEnum.EmpIdFk.index();
    public static final int AMOUNTADVANCED = AttributesEnum.AmountAdvanced.index();
    ...
    public static final int TRAVLEXPDOCNO = AttributesEnum.TravlExpDocNo.index();
    ...
    public static final int DSSTRAVELEXPANSEAMOUNTDTL = AttributesEnum.DssTravelexpanseAmountDtl.index();
    public static final int DSSTRAVELEXPANSEDETAIL = AttributesEnum.DssTravelexpanseDetail.index();
    public static final int DSSTRAVELEXPANSEPURPOSEDTL = AttributesEnum.DssTravelExpansePurposeDtl.index();

    /**
     * This is the default constructor (do not remove).
     */
    public DssTravelExpanseReimbursementImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("dss.pqt.travelExp.model.eo.DssTravelExpanseReimbursement");
    }


    /**
     * Gets the attribute value for VoucherIdPk, using the alias name VoucherIdPk.
     * @return the value of VoucherIdPk
     */
    public Number getVoucherIdPk() {
        return (Number) getAttributeInternal(VOUCHERIDPK);
    }

    /**
     * Sets <code>value</code> as the attribute value for VoucherIdPk.
     * @param value value to set the VoucherIdPk
     */
    public void setVoucherIdPk(Number value) {
        setAttributeInternal(VOUCHERIDPK, value);
    }

    /**
     * Gets the attribute value for EmpIdFk, using the alias name EmpIdFk.
     * @return the value of EmpIdFk
     */
    public Number getEmpIdFk() {
        return (Number) getAttributeInternal(EMPIDFK);
    }

    /**
     * Sets <code>value</code> as the attribute value for EmpIdFk.
     * @param value value to set the EmpIdFk
     */
    public void setEmpIdFk(Number value) {
        setAttributeInternal(EMPIDFK, value);
    }

    /**
     * Gets the attribute value for AmountAdvanced, using the alias name AmountAdvanced.
     * @return the value of AmountAdvanced
     */
    public Number getAmountAdvanced() {
        return (Number) getAttributeInternal(AMOUNTADVANCED);
    }

    /**
     * Sets <code>value</code> as the attribute value for AmountAdvanced.
     * @param value value to set the AmountAdvanced
     */
    public void setAmountAdvanced(Number value) {
        setAttributeInternal(AMOUNTADVANCED, value);
    }
    ...
    /**
     * Gets the attribute value for GrandTotal, using the alias name GrandTotal.
     * @return the value of GrandTotal
     */
    ...
    /**
     * Sets <code>value</code> as the attribute value for GrandTotal.
    ...
    /**
     * Gets the attribute value for TravlExpDocNo, using the alias name TravlExpDocNo.
     * @return the value of TravlExpDocNo
     */
    public String getTravlExpDocNo() {
        return (String) getAttributeInternal(TRAVLEXPDOCNO);
    }

    /**
     * Sets <code>value</code> as the attribute value for TravlExpDocNo.
     * @param value value to set the TravlExpDocNo
     */
    public void setTravlExpDocNo(String value) {
        setAttributeInternal(TRAVLEXPDOCNO, value);
    }
     ...
     */
    public RowIterator getDssTravelexpanseAmountDtl() {
        return (RowIterator) getAttributeInternal(DSSTRAVELEXPANSEAMOUNTDTL);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getDssTravelexpanseDetail() {
        return (RowIterator) getAttributeInternal(DSSTRAVELEXPANSEDETAIL);
    }

    /**
     * @return the associated entity oracle.jbo.RowIterator.
     */
    public RowIterator getDssTravelExpansePurposeDtl() {
        return (RowIterator) getAttributeInternal(DSSTRAVELEXPANSEPURPOSEDTL);
    }


    /**
     * @param voucherIdPk key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number voucherIdPk) {
        return new Key(new Object[] { voucherIdPk });
    }
     ...
     */
         protected void create(AttributeList attributeList) {
             ...
             SequenceImpl seq = new SequenceImpl("DSS_TRAVE_REIMBURSE_SEQ", getDBTransaction());
             setVoucherIdPk(seq.getSequenceNumber());
             
             setBranchStatus("INCOMPLETE");
             setDssStatus("INCOMPLETE");

             ViewObject vo=getDBTransaction().getRootApplicationModule().findViewObject("TravelUserLocVO");
             if (vo!=null)
               {
                       vo.remove();
               }
             ...
             try {
                 ...
                 vo=getDBTransaction().getRootApplicationModule().createViewObjectFromQueryStmt("TravelUserLocVO", "select  GIS_LOCATION_ID_FK from DSS_SM_USERS WHERE USER_ID_PK="+getUserIdFk());
                 vo.executeQuery();
         ...
         protected void doDML(int operation, TransactionEvent e) {
             if (operation == DML_INSERT) {
                 ...
                 CallableStatement callableStatement =
                     txn.createCallableStatement("begin ? := dss_all_pkg.GET_TRAVL_EXP_NUMBER; end;", DBTransaction.DEFAULT);
                 try {
                     callableStatement.registerOutParameter(1, Types.VARCHAR);
                     callableStatement.executeUpdate();
                     String vTravelExpNumber = callableStatement.getString(1);
                     callableStatement.close();
                     setTravlExpDocNo(vTravelExpNumber);
